...
public class NovelService {
  ...
  public interface Iface {
    ...
    public NovelChapterContext getNovelChapterContextByChapterUrl(java.lang.String chapterUrl) throws org.apache.thrift.TException;

    public Novel getNovelChapterListByNovelUrl(java.lang.String novelUrl) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getNovelChapterContextByChapterUrl(java.lang.String chapterUrl, org.apache.thrift.async.AsyncMethodCallback<NovelChapterContext> resultHandler) throws org.apache.thrift.TException;

    public void getNovelChapterListByNovelUrl(java.lang.String novelUrl, org.apache.thrift.async.AsyncMethodCallback<Novel> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getNovelChapterContextByChapterUrl(java.lang.String chapterUrl) throws org.apache.thrift.TException
    {
    ...
    public void send_getNovelChapterListByNovelUrl(java.lang.String novelUrl) throws org.apache.thrift.TException
    {
    ...
    public Novel recv_getNovelChapterListByNovelUrl() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getNovelChapterContextByChapterUrl_call extends org.apache.thrift.async.TAsyncMethodCall<NovelChapterContext> {
      private java.lang.String chapterUrl;
      public getNovelChapterContextByChapterUrl_call(java.lang.String chapterUrl, org.apache.thrift.async.AsyncMethodCallback<NovelChapterContext> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class getNovelChapterListByNovelUrl_call extends org.apache.thrift.async.TAsyncMethodCall<Novel> {
      private java.lang.String novelUrl;
      public getNovelChapterListByNovelUrl_call(java.lang.String novelUrl, org.apache.thrift.async.AsyncMethodCallback<Novel> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      ...
      public Novel getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getNovelChapterListByNovelUrl<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getNovelChapterListByNovelUrl_args, Novel> {
      public getNovelChapterListByNovelUrl() {
        super("getNovelChapterListByNovelUrl");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Novel> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<Novel>() { 
          public void onComplete(Novel o) {
            getNovelChapterListByNovelUrl_result result = new getNovelChapterListByNovelUrl_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getNovelChapterListByNovelUrl_args args, org.apache.thrift.async.AsyncMethodCallback<Novel> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class getNovelChapterContextByChapterUrl_args implements org.apache.thrift.TBase<getNovelChapterContextByChapterUrl_args, getNovelChapterContextByChapterUrl_args._Fields>, java.io.Serializable, Cloneable, Comparable<getNovelChapterContextByChapterUrl_args>   {
    ...
    public java.lang.String chapterUrl; // required
    ...
    public java.lang.String getChapterUrl() {
      return this.chapterUrl;
    }

    public getNovelChapterContextByChapterUrl_args setChapterUrl(java.lang.String chapterUrl) {
      this.chapterUrl = chapterUrl;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case CHAPTER_URL:
        if (value == null) {
          ...
          setChapterUrl((java.lang.String)value);
        }
        break;
    ...
    public int compareTo(getNovelChapterContextByChapterUrl_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetChapterUrl()).compareTo(other.isSetChapterUrl());
      if (lastComparison != 0) {
    ...
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("getNovelChapterContextByChapterUrl_args(");
      boolean first = true;
  ...
  public static class getNovelChapterContextByChapterUrl_result implements org.apache.thrift.TBase<getNovelChapterContextByChapterUrl_result, getNovelChapterContextByChapterUrl_result._Fields>, java.io.Serializable, Cloneable, Comparable<getNovelChapterContextByChapterUrl_result>   {
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("getNovelChapterContextByChapterUrl_result(");
      boolean first = true;
  ...
  public static class getNovelChapterListByNovelUrl_args implements org.apache.thrift.TBase<getNovelChapterListByNovelUrl_args, getNovelChapterListByNovelUrl_args._Fields>, java.io.Serializable, Cloneable, Comparable<getNovelChapterListByNovelUrl_args>   {
    ...
    public java.lang.String novelUrl; // required
    ...
    public java.lang.String getNovelUrl() {
      return this.novelUrl;
    }

    public getNovelChapterListByNovelUrl_args setNovelUrl(java.lang.String novelUrl) {
      this.novelUrl = novelUrl;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case NOVEL_URL:
        if (value == null) {
          ...
          setNovelUrl((java.lang.String)value);
        }
        break;
    ...
    public int compareTo(getNovelChapterListByNovelUrl_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetNovelUrl()).compareTo(other.isSetNovelUrl());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetNovelUrl()) {
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("getNovelChapterListByNovelUrl_args(");
      boolean first = true;
  ...
  public static class getNovelChapterListByNovelUrl_result implements org.apache.thrift.TBase<getNovelChapterListByNovelUrl_result, getNovelChapterListByNovelUrl_result._Fields>, java.io.Serializable, Cloneable, Comparable<getNovelChapterListByNovelUrl_result>   {
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Novel.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getNovelChapterListByNovelUrl_result(getNovelChapterListByNovelUrl_result other) {
      if (other.isSetSuccess()) {
        this.success = new Novel(other.success);
      }
    }
    ...
    public Novel getSuccess() {
      return this.success;
    }

    public getNovelChapterListByNovelUrl_result setSuccess(Novel success) {
      this.success = success;
      return this;
    }
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("getNovelChapterListByNovelUrl_result(");
      boolean first = true;
